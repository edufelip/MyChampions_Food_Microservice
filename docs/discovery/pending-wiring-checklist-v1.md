...
| W-003 | FatSecret IP `165.22.147.90` allowlisted | ⬜ Pending | Must be done in FatSecret developer portal |
| W-004 | TLS certificate issued for VPS domain | ⬜ Pending | Run Certbot: `certbot --nginx -d food.mychampions.app` |
